...
exports.default = (0, config_1.defineConfig)({
    schema: node_path_1.default.join(import.meta.dirname ?? __dirname, "schema.prisma"),
    migrate: {
        async adapter(env) {
            const { PrismaNeon } = await Promise.resolve().then(() => __importStar(require("@prisma/adapter-neon")));
